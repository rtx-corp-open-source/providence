...
from providence.loss import T_Loss, discrete_weibull_loss_fn
from providence.loss import discrete_weibull_mse
from providence.nn import ProvidenceLSTM
from providence.paper_reproductions import NasaFD001TransformerOptimizer
...
optimizer = NasaFD001TransformerOptimizer(model)._replace(num_epochs=5)
