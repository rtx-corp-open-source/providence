...
"""
Brought in to compare against the Providence Transformer. Partially vendored from the TST codebase.
The Time Series Transfromer+ network, courtesy of TSAI.

Not to be imported or utilized, but here for documentation purposes.
...
from providence_utils.fastai_layers import Flatten, GACP1d, GAP1d, LinLnDrop, Pad1d, SigmoidRange, Transpose

from providence_utils.fastai_utils import delegates, ifnone, pv
from ..imports import *
from ..utils import *
from .layers import *
from .utils import *
