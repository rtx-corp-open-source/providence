"""
Purpose:
To have a reference outline for the correct manner of training with Horovod.
There is much more here than is necessary for our code base.
This file is thus marked for deletion.
    ...
    def train_mixed_precision(epoch, scaler):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if batch_idx % args.log_interval == 0:
                ...
                print(
                    "Train Epoch: {} [{}/{} ({:.0f}%)]\tLoss: {:.6f}\tLoss Scale: {}".format(
                        epoch,
                        batch_idx * len(data),
                        len(train_sampler),
