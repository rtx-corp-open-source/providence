...
from providence.nn.transformer.deepmind import (AttentionHead,
                                                CausalSelfAttention, CSAConfig,
                                                Decoder, EDTransformer,
                                                Encoder, ETransformer,
                                                MaskMode, MHAttention)
...
class TestDMTransformerComponents:
    ...
    class TestAttentionHead:
        ...
        def test_init(self):
            n_test_features = 4
            AttentionHead(n_test_features, n_test_features, 8, mask=MaskMode.unmasked, inner_att_dim=6)

        def test_forward(self):
            n_test_features = 4
            n_test_samples = 3
            n_time_steps = 8
            test_head = AttentionHead(n_test_features, n_test_features, att_out_dim=11, mask=MaskMode.unmasked, inner_att_dim=6)

            test_examples: TensorType["batch", "time", "features",] = pt.randn(n_test_samples, n_time_steps, n_test_features)
    ...
    class TestMultiheadAttention:
        ...
        def test_init(self):
            n_test_features = 3
            MHAttention(2, n_test_features, n_test_features, 16, mask_mode=MaskMode.backward_only, att_inner_dim=6)

        def test_forward_default_initialization(self):
            n_test_features = 5
            n_test_samples = 3
            n_time_steps = 8
            test_head = MHAttention(2, n_test_features, n_test_features, att_out_dim=11, mask_mode=MaskMode.unmasked, att_inner_dim=6)
        ...
        def test_forward__specific_output_dim__iterating_n_heads(self, n_heads: int):
            ...
            n_test_samples = 3
            n_time_steps = 8
            test_head = MHAttention(n_heads, n_test_features, n_test_features, att_out_dim=11, mask_mode=MaskMode.unmasked, att_inner_dim=6, output_dim=2)
    ...
    class TestCausalSelfAttention:
        ...
        def test_forward__specific_output_dim__iterating_n_heads(self, n_heads: int):
            ...
            test_examples = pt.nn.functional.linear(test_examples, pt.randn(test_head.n_embd, n_test_features)) # pt.randn(test_head.n_embd, n_test_features) @ test_examples
    ...
    class TestEncoder:
        ...
        def test_forward(self, n_heads):
            n_test_features = 5
            encoder = Encoder(n_heads, n_test_features, mask_mode=MaskMode.backward_only, att_inner_dim=11)
    ...
    class TestEncoderDecoderTransformer:
        ...
        def test_init(self):
            ...
            n_test_features = 5
            n_heads = 2
            EDTransformer(n_heads, 2, n_test_features, 20, mask_mode=MaskMode.unmasked, max_seq_len=10, att_inner_dim=6)

        @pytest.mark.parametrize("n_heads", [2, 3, 4, 5, 6])
        def test_forward(self, n_heads):
            n_test_features = 5
            enc_dec = EDTransformer(n_heads, 2, n_test_features, 20, mask_mode=MaskMode.unmasked, max_seq_len=10, att_inner_dim=60)
    ...
    class TestEncoderOnlyTransformer:
        ...
        def test_init(self):
            ...
            n_test_features = 5
            n_heads = 2
            ETransformer(n_heads, 2, n_test_features, 20, mask_mode=MaskMode.unmasked, max_seq_len=10, att_inner_dim=6)

        @pytest.mark.parametrize("n_heads", [2, 3, 4, 5, 6])
        def test_forward(self, n_heads):
            n_test_features = 5
            encoder = ETransformer(n_heads, 2, n_test_features, 20, mask_mode=MaskMode.unmasked, max_seq_len=10, att_inner_dim=6)
