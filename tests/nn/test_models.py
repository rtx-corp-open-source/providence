...
from providence.loss import DiscreteWeibullLoss, DiscreteWeibull3Loss
from providence.nn import ProvidenceGRU, ProvidenceLSTM, transformer
from providence.nn.rnn import ProvidenceRNN, ProvidenceVanillaRNN
...
@pytest.mark.parametrize(
    "providence_model",
    [
        (ProvidenceGRU, {"input_size": 20, "dropout": 0.3, "num_layers": 2, "hidden_size": 100}, 2),
        (ProvidenceLSTM, {"input_size": 20, "dropout": 0.3, "num_layers": 2, "hidden_size": 100}, 2),
        (ProvidenceVanillaRNN, {"input_size": 20, "dropout": 0.3, "num_layers": 2, "hidden_size": 100}, 2),
        (ProvidenceGRU, {"input_size": 20, "dropout": 0.3, "num_layers": 2, "hidden_size": 100, "activation": "weibull3"}, 3),
        (ProvidenceLSTM, {"input_size": 20, "dropout": 0.3, "num_layers": 2, "hidden_size": 100, "activation": "weibull3"}, 3),
        (ProvidenceVanillaRNN, {"input_size": 20, "dropout": 0.3, "num_layers": 2, "hidden_size": 100, "activation": "weibull3"}, 3),
    ],
)
...
@pytest.mark.parametrize(
    "model_and_kwargs",
    [
        (ProvidenceGRU, {"dropout": 0.3, "num_layers": 2, "hidden_size": 100, "activation": "weibull3"}),
        (ProvidenceLSTM, {"dropout": 0.3, "num_layers": 2, "hidden_size": 100, "activation": "weibull3"}),
        (ProvidenceVanillaRNN, {"dropout": 0.3, "num_layers": 2, "hidden_size": 100, "activation": "weibull3"}),
    ],
...
@pytest.mark.parametrize(
    "providence_model",
    [(ProvidenceGRU, {"input_size": 24}), (ProvidenceLSTM, {"input_size": 24}), (ProvidenceVanillaRNN, {"input_size": 24})],
)
...
class TestProvidenceTransformer:
    ...
    def model_temporal(self, simple_providence_ds) -> transformer.ProvidenceTransformer:
        return transformer.ProvidenceTransformer(model_dimension=simple_providence_ds.n_features, hidden_size=12, n_attention_heads=2)
    ...
    def test_successful_end2end__mha2(self, simple_providence_ds, model_temporal: transformer.ProvidenceTransformer):
        ...
        model_temporal = transformer.ProvidenceTransformer(
            model_temporal.d_model,model_temporal.ff_dimension, n_layers=model_temporal.n_layers,
            n_attention_heads=model_temporal.n_attention_heads, dropout=model_temporal.dropout,
            layer_norm_epsilon=model_temporal.layer_norm_epsilon, positional_encoding_dimension=model_temporal.positional_encoding_dimension,
            attention_axis=model_temporal.attention_axis, device=model_temporal.device,
    ...
    def test_successful_end2end_BERTish_model(self, simple_providence_ds: ProvidenceDataset, model_temporal: transformer.ProvidenceTransformer):
        "Make sure that we can invoke the model with the full dressings."
        ...
        examples, lengths, targets = providence_collate_fn([simple_providence_ds[i] for i in range(len(simple_providence_ds))])
