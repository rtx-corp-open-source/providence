...
from providence.datasets.backblaze import BackblazeQuarter
from providence.datasets.core import DataSubsetId


@pytest.fixture(scope="module")
def ds1() -> ProvidenceDataset:
    """
...
class Test_DatasetConstruction:
    ...
    @classmethod
    def assert_length(cls, ds: ProvidenceDataset, length: int, msg: str = None):
        if msg is None:
    ...
    def test_concat_dataset__wraps_correctl(self, ds1, ds2):
        ...
        self.assert_length(
            catds,
            len(ds1) + len(ds2),
            "concatenated dataset should be correctly sized.",
        )
