...
class ProvidenceVanillaRNN(nn.Module):
    def __init__(self, input_size: int, hidden_size: int = 20, n_layers: int = 1, dropout: float = 0, nonlinearity: str = "tanh"):
        super().__init__()
    ...
    def reset_parameters(self):
        self.rnn = nn.RNN(self.input_size, self.hidden_size, self.n_layers, dropout=self.dropout, nonlinearity=self.nonlinearity)
