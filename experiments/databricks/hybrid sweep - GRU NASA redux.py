...
def do_mlflow_run(
    ...
    with mlflow.start_run(experiment_id=experiment_id):
        ...
        cbs = [
            ...
            WriteModelOutputs(callback_config["model_output_freq"], output_dir, logger=logger, verbose=False, dist_t=dist_t),
            ModelCheckpointer(
...
def weibull3_training_epoch(
    ...
    averaged_losses = losses._replace(training=losses.training / len(dataloaders.train), validation=losses.validation / len(dataloaders.validation))
